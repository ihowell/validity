...
#
# Generally:
#   C // 3 is the number of mixtures
#   T is the number of dimensions in the output
...
def discretized_mix_logistic_loss(y_hat,
    ...
    inner_inner_cond = (cdf_delta > epsilon).float()
...
def sample_from_discretized_mix_logistic(y,
    ...
    temp = logit_probs.data.new(logit_probs.size()).uniform_(epsilon, 1.0 - epsilon)
